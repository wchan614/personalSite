...
<head>
  ...
  <title>Memory Test - Visual Memory</title>
	...
	<main style="min-height: 700px;">
        <div class="jumbotron jumbotron-fluid mt-2">
            <div class="container text-center">
                <h1 class="display-4">Visual Memory</h1>
            </div>
        </div>
		<div class="container-fluid text-center " style="min-height: 350px">
			...
			<div class="d-none " id="gameDiv">
				...
				<br>
				<div id="rememberDiv">
					<div class="container" id="rememberGrid" style="height:500px; width:500px">
					</div>
					<br>
				...
				<div class="d-none" id="inputDiv">
					<div class="container" id="inputGrid" style="height:500px; width:500px">
					</div>
					<br>
				</div>
			...
			<div class="d-none" id="gameoverDiv">
				...
				<div class="form-group">
					...
					<button class="btn btn-primary mb-4" onClick="window.location.href=window.location.href">Try again?</button>					
				</div>
			</div>
		</div>
        </div>
        ...
        <div class="jumbotron jumbotron-fluid mt-2 text-center">
                ...
                <p class="lead">Tiles will be shown and disappear, you'll need to click the tiles that were highlighted.  </p>
                <p class="lead">You have 3 attempts and 3 chances for each tile.</p>
