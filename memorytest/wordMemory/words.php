...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<main>
		<div class="container-fluid">
			<div id="startDiv">
				<h2 class="">Word Memory</h2>
				<p>If the word displayed was shown before, click on "Seen". If it was not shown before, click on "New".</p>
				<button class="btn-primary" id="startButton" onClick="start()">Start</button>
			</div>

			<div class="d-none" id="gameDiv">
				<h1 class="" id="word"></h1>
				<button class="btn-primary" id="seenButton" onClick="playerPick(true)">Seen</button>
				<button class="btn-primary" id="newButton" onClick="playerPick(false)">New</button>
				<h2 class="" id="lives">Lives: 3</h2>
